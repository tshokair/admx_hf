...
for i in range (1,n_ss):
    sp.append([a+10*(i%19+1) for a in p[i]])
...
#plot all spectra
p1=figure(x_axis_label="frequency [GHz]",y_axis_label="Processed Power")
...
hist_pts=single_bin_dev(p)
hist1, edges1 = np.histogram(hist_pts,bins=500)
...
hist_pts_sum=summed_bin_dev(p)
hist2, edges2 = np.histogram(hist_pts_sum,bins=5000)
...
show (vplot(p1,p1_0,p2,p3,p3_0,p4))
